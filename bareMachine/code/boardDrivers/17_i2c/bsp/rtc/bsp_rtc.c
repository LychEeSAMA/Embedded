 ...
 * @return 			: 转换后的秒数
 */
static unsigned int rtc_coverdate_to_seconds(struct rtc_datetime *datetime)
{
    unsigned short i = 0;
 ...
 * @return 		: 当前秒数
 */
static unsigned int rtc_get_seconds(void)
{
    unsigned int seconds = 0;
 ...
 * @return 			: 无
 */
void rtc_get_date_time(struct rtc_datetime *datetime)
{
    // unsigned int seconds = 0;
    u64 seconds;
 ...
 * @return 			: 无
 */
void rtc_set_date_time(struct rtc_datetime *datetime)
{
